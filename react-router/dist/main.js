...
function Table(_ref) {
  ...
  var tableRows = articles.map(function (item, index) {
    var id = index + 1;
    return /*#__PURE__*/react.createElement("tr", {
      key: id
    }, /*#__PURE__*/react.createElement("td", null, id), /*#__PURE__*/react.createElement("td", null, /*#__PURE__*/react.createElement(Link, {
      to: "/details/".concat(id - 1, "?title=").concat(item.title, "&publishedAt=").concat(item.publishedAt)
    }, " ", item.title)), /*#__PURE__*/react.createElement("td", null, item.author), /*#__PURE__*/react.createElement("td", null, item.content), /*#__PURE__*/react.createElement("td", null, item.publishedAt), /*#__PURE__*/react.createElement("td", null, item.url), /*#__PURE__*/react.createElement("td", null, item.urlToImage));
  });
  return /*#__PURE__*/react.createElement("table", {
    className: "table"
  }, /*#__PURE__*/react.createElement("thead", null, /*#__PURE__*/react.createElement("tr", null, /*#__PURE__*/react.createElement("th", null, "#"), /*#__PURE__*/react.createElement("th", null, "Title"), /*#__PURE__*/react.createElement("th", null, "Author"), /*#__PURE__*/react.createElement("th", null, "Content"), /*#__PURE__*/react.createElement("th", null, "Published"), /*#__PURE__*/react.createElement("th", null, "URL"), /*#__PURE__*/react.createElement("th", null, "URL to image"))), /*#__PURE__*/react.createElement("tbody", null, tableRows));
}
...
var Form = function Form(_ref) {
  ...
  var _useState3 = (0,react.useState)(false),
      ...
      checkSubmit = _useState4[0],
      setCheckSubmit = _useState4[1];
  ...
  var _useState7 = (0,react.useState)('popularity'),
  ...
  var _useState9 = (0,react.useState)(10),
      ...
      resultsPerPage = _useState10[0],
      setResultsPerPage = _useState10[1];

  var _useState11 = (0,react.useState)('1'),
      _useState12 = _slicedToArray(_useState11, 2),
      totalResults = _useState12[0],
      setTotalResults = _useState12[1];
  ...
  function handleSubmit(event) {
    ...
    if (/\w/.test(search)) {
      setLoading(true);
      fetch("https://newsapi.org/v2/everything?q=".concat(search, "&sortBy=").concat(sort, "&pageSize=").concat(resultsPerPage, "&page=").concat(pageNumber, "&apiKey=5ada2f2e485b4f11b600736fa619867c")).then(function (resp) {
        return resp.json();
      }).then(function (obj) {
        if (obj.status === 'ok') {
          setLoading(false);
  ...
  function changePageNumber(event) {
    if (event.currentTarget.id === 'btnRight' && Number(pageNumber) < Math.ceil(Number(totalResults) / resultsPerPage)) {
      setPageNumber(function (state) {
        return "".concat(Number(state) + 1);
      });
  ...
  return /*#__PURE__*/react.createElement("form", {
  ...
  }, checkSubmit && /*#__PURE__*/react.createElement("span", {
    className: "error"
  }, "Please, enter letters or digits!"), /*#__PURE__*/react.createElement("div", {
    ...
    type: "submit",
    className: "searchBar__input searchBar__input_btn",
    value: "Search",
    disabled: loading
    ...
    onClick: function onClick() {
      return setSort('relevancy');
    }
  }, "Relevancy"), /*#__PURE__*/react.createElement("button", {
    type: "submit",
    className: "btn-sort",
    disabled: loading,
    onClick: function onClick() {
      return setSort('popularity');
    }
  }, "Popularity"), /*#__PURE__*/react.createElement("button", {
    type: "submit",
    className: "btn-sort",
    disabled: loading,
    onClick: function onClick() {
      return setSort('publishedAt');
    }
  }, "Published at")), /*#__PURE__*/react.createElement("div", {
    className: "form__pagination"
  }, /*#__PURE__*/react.createElement("button", {
    type: "submit",
    ...
    type: "text",
    disabled: true,
    value: "".concat(pageNumber, " / ").concat(Math.max(1, Math.ceil(Number(totalResults) / Number(resultsPerPage))))
  }), /*#__PURE__*/react.createElement("button", {
    type: "submit",
    className: "btn-pagination",
    disabled: loading,
  ...
  }, "Results per page:", /*#__PURE__*/react.createElement("select", {
    name: "resultsPerPage",
    className: "form__input",
    value: resultsPerPage,
    onChange: function onChange(e) {
      return setResultsPerPage(Number(e.target.value));
    }
...
var Header = function Header() {
  var _useState = (0,react.useState)({
    ...
    about: 'nav__item'
      ...
      chosenLink = _useState2[0],
      setChosenLink = _useState2[1];
  ...
  return /*#__PURE__*/react.createElement("header", {
    ...
    className: chosenLink.home
  }, /*#__PURE__*/react.createElement(Link, {
    to: "/",
    className: "nav__link"
  }, /*#__PURE__*/react.createElement("span", null, "Home"))), /*#__PURE__*/react.createElement("li", {
    className: chosenLink.about
  }, /*#__PURE__*/react.createElement(Link, {
    to: "/about",
    className: "nav__link"
  }, /*#__PURE__*/react.createElement("span", null, "About"))))));
};

/* harmony default export */ const header = (Header);
;// CONCATENATED MODULE: ./src/components/404.tsx
...
var Page404 = function Page404() {
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "four__title four__title_h2"
  }, "404"), /*#__PURE__*/react.createElement("h3", {
    className: "four__title four__title_h3"
  }, "Oops... you seem to be lost"), /*#__PURE__*/react.createElement("p", {
    className: "four__text"
  }, "Just don&lsquot be discouraged, but there is no such page :("));
};

/* harmony default export */ const _404 = (Page404);
;// CONCATENATED MODULE: ./src/components/page-details.tsx
function page_details_slicedToArray(arr, i) { return page_details_arrayWithHoles(arr) || page_details_iterableToArrayLimit(arr, i) || page_details_unsupportedIterableToArray(arr, i) || page_details_nonIterableRest(); }

function page_details_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function page_details_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return page_details_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return page_details_arrayLikeToArray(o, minLen); }

function page_details_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function page_details_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function page_details_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var PageDetails = function PageDetails(_ref) {
  ...
  var _useState = (0,react.useState)({}),
      _useState2 = page_details_slicedToArray(_useState, 2),
      data = _useState2[0],
      setData = _useState2[1];

  (0,react.useEffect)(function () {
    fetch("https://newsapi.org/v2/everything?qInTitle=".concat(title, "&from=").concat(publishedAt, "&to=").concat(publishedAt, "&pageSize=1&apiKey=5ada2f2e485b4f11b600736fa619867c")).then(function (resp) {
      return resp.json();
    }).then(function (resp) {
      return setData(resp.articles[0]);
    })["catch"](function (e) {
      return setError({
        err: true,
        errMessage: e.message
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, !data.title && !error.err && /*#__PURE__*/react.createElement("div", null, "Loading..."), error.err && /*#__PURE__*/react.createElement("div", {
    className: "error error_table"
  }, error.errMessage, "..."), data.title && /*#__PURE__*/react.createElement("div", {
    className: "details"
  }, /*#__PURE__*/react.createElement("h2", {
    className: "details__title"
  }, data.title), /*#__PURE__*/react.createElement("h3", {
    className: "details__author"
  }, "Author: ", data.author), /*#__PURE__*/react.createElement("img", {
    src: data.urlToImage,
    alt: "foto",
    className: "details__foto"
  }), /*#__PURE__*/react.createElement("div", {
    className: "details__contain"
  }, "Content: ", data.content), /*#__PURE__*/react.createElement("div", {
    className: "details__contain"
...
/* harmony default export */ const page_details = (PageDetails);
...
var App = function App() {
  ...
  return /*#__PURE__*/react.createElement(BrowserRouter, null, /*#__PURE__*/react.createElement(header, null), /*#__PURE__*/react.createElement(Route, {
    path: "/",
    exact: true
  }, function (_ref) {
    ...
    return /*#__PURE__*/react.createElement(esm_CSSTransition, {
      ...
      error: error,
      setError: setError
    }), error.err && /*#__PURE__*/react.createElement("span", {
      className: "error error_table"
    }, error.errMessage, "..."), !error.err && /*#__PURE__*/react.createElement(table, {
      articles: articles
    })));
    ...
    render: function render(_ref3) {
      ...
      var indexPublishedAt = location.search.indexOf('&publishedAt=');
      var title = location.search.slice(7, indexPublishedAt);
      var publishedAt = location.search.slice(indexPublishedAt);
      return /*#__PURE__*/react.createElement(page_details, {
        title: title,
    ...
    path: "/404"
  }, /*#__PURE__*/react.createElement(_404, null)));
};
